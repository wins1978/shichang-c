/* 
Name: EXCEL_IMPORT_DAILY_V
Description: Extends Linq Type Defines about Table : EXCEL_IMPORT_DAILY_V
*/
using System;
...
namespace ExcelPro
{
    [Table(Name = "EXCEL_IMPORT_DAILY_V3")]
    [DataContract]
    [Serializable]
    public partial class EXCEL_IMPORT_DAILY_V3
    {
        #region 表名称常量
        /// <summary>
        /// 表名称
        /// </summary>
        public const string TABLE_NAME = "EXCEL_IMPORT_DAILY_V3";
        #endregion
        ...
        /// G_GOODS_NAME的字段名
        /// </summary>
        public const string F_G_GOODS_NAME = "G_GOODS_NAME";

        /// <summary>
        /// V_VENDOR的字段名
        /// </summary>
        public const string F_V_VENDOR = "V_VENDOR";

        /// <summary>
        /// VG_VENDOR的字段名
        /// </summary>
        public const string F_VG_VENDOR = "VG_VENDOR";

        /// <summary>
        /// VG_GOODS_NAME的字段名
        /// </summary>
        public const string F_VG_GOODS_NAME = "VG_GOODS_NAME";
        ...
        private Nullable<DateTime> _CREATE_DATETIME;
        private string _IMPORT_DATE_STR;
        private string _FILE_NAME;
        private string _GUID_KEY;
        private Nullable<int> _ROW_INDEX;
        private string _G_GOODS_NAME;
        private string _V_VENDOR;
        private string _VG_VENDOR;
        private string _VG_GOODS_NAME;
        ...
        [Column(Storage = "_CREATE_DATETIME", CanBeNull = true)]
        [DataMember(IsRequired = true)]
        public virtual Nullable<DateTime> CREATE_DATETIME
        {
            get
            {
        ...
        /// 
        /// </summary>
        [Column(Storage = "_G_GOODS_NAME", CanBeNull = true)]
        [DataMember(IsRequired = true)]
        public virtual string G_GOODS_NAME
        {
            get
            {
                return this._G_GOODS_NAME == null ? "" : this._G_GOODS_NAME;
            }
            set
            {
                if ((this._G_GOODS_NAME != value))
                {
                    this._G_GOODS_NAME = value;
                }
            }
        }
        /// <summary>
        /// 
        /// </summary>
        [Column(Storage = "_V_VENDOR", CanBeNull = true)]
        [DataMember(IsRequired = true)]
        public virtual string V_VENDOR
        {
            get
            {
                return this._V_VENDOR == null ? "" : this._V_VENDOR;
            }
            set
            {
                if ((this._V_VENDOR != value))
                {
                    this._V_VENDOR = value;
                }
            }
        }
        /// <summary>
        /// 
        /// </summary>
        [Column(Storage = "_VG_VENDOR", CanBeNull = true)]
        [DataMember(IsRequired = true)]
        public virtual string VG_VENDOR
        {
            get
            {
                return this._VG_VENDOR == null ? "" : this._VG_VENDOR;
            }
            set
            {
                if ((this._VG_VENDOR != value))
                {
                    this._VG_VENDOR = value;
                }
            }
        }
        /// <summary>
        /// 
        /// </summary>
        [Column(Storage = "_VG_GOODS_NAME", CanBeNull = true)]
        [DataMember(IsRequired = true)]
        public virtual string VG_GOODS_NAME
        {
            get
            {
                return this._VG_GOODS_NAME == null ? "" : this._VG_GOODS_NAME;
            }
            set
            {
                if ((this._VG_GOODS_NAME != value))
                {
                    this._VG_GOODS_NAME = value;
                }
            }
        }
        /// <summary>
