/* 
Name: EXCEL_VENDOR_GOODS_HIS
Description: Extends Linq Type Defines about Table : EXCEL_VENDOR_GOODS_HIS
*/
using System;
...
namespace ExcelPro
{
    [Table(Name = "EXCEL_VENDOR_GOODS_HIS")]
    [DataContract()]
    [Serializable]
    public partial class EXCEL_VENDOR_GOODS_HIS : Tencent.OA.ATQ.Model.IModel
    {
        #region 表名称常量
        ...
        /// 表名称
        /// </summary>
        public const string TABLE_NAME = "EXCEL_VENDOR_GOODS_HIS";
        #endregion
        ...
        /// 
        /// </summary>
        [Column(Storage = "_ID", IsPrimaryKey = false, CanBeNull = false)]
