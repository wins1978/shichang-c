/* 
Name: EXCEL_MONTHLY_SUMMARY
Description: Extends Linq Type Defines about Table : EXCEL_MONTHLY_SUMMARY
*/
using System;
...
namespace ExcelPro
{
    [Table(Name = "EXCEL_MONTHLY_SUMMARY")]
    [DataContract()]
    [Serializable]
    public partial class EXCEL_MONTHLY_SUMMARY : Tencent.OA.ATQ.Model.IModel
    {
        #region 表名称常量
        ...
        /// 表名称
        /// </summary>
        public const string TABLE_NAME = "EXCEL_MONTHLY_SUMMARY";
        #endregion
